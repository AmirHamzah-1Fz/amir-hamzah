...
const featureIsAnExperimentalAlertBox = document.getElementById(
  'featureIsAnExperimentalAlertBox'
);
const featureIsAnExperimentalAlertContainer = document.getElementById(
  'featureIsAnExperimentalAlertContainer'
);
...
document.addEventListener('click', (e) => {
  if (
    ...
    !navbarBox.contains(e.target) &&
    !themeItems.contains(e.target) &&
    !notifications.contains(e.target) &&
    !notificationBox.contains(e.target) &&
    !cursorDefaultUs.contains(e.target) &&
    !cursorGlassUs.contains(e.target) &&
    !cursorBlurUs.contains(e.target)
  ) {
    menuItem.classList.remove('h-[215px]');
    menuItem.classList.remove('py-4');
    exitMenu.classList.remove('top-0');
...
const singleArrowBottomTheme = document.getElementById(
  'singleArrowBottomTheme'
);
...
const unsupportedAlertBottomSatu = document.getElementById(
  'unsupportedAlertBottomSatu'
);
const unsupportedAlertBottomDua = document.getElementById(
  'unsupportedAlertBottomDua'
);
const unsupportedAlertBottomTiga = document.getElementById(
  'unsupportedAlertBottomTiga'
);
